...
namespace sf {
    ...
    void EOMFiveDOF :: computeEOM(double timestep) {
        ...
        globals->alpha = atan2( globals->uvw.get3() , globals->uvw.get1());
        globals->beta =  asin( globals->uvw.get2() / globals->vInf );
        globals->alphaDot = atan2( globals->uvwdot.get3() , globals->uvw.get1());
        globals->betaDot =  asin( globals->uvwdot.get2() / globals->vInf );
